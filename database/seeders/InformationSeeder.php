...
class InformationSeeder extends Seeder
{
    public function run()
    {
        ...
        $infoListData = [
            ['title' => 'Visi & Misi', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['title' => 'Rumah Belajar Anak', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
            ['title' => 'KB & SD Inklusi Talenta', 'created_at' => Carbon::now(), 'updated_at' => Carbon::now()],
        ];
